...
public class Capitals {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Type in a state and I'll give you a State capital");
        String sCapitals = scanner.nextLine();

        if (!isCapital(sCapitals)){
            System.out.println("Not a state in my database. :(");
        } else {


            System.out.println("The capital of " + sCapitals + " is " + getCapitals().get(sCapitals) + ".");
